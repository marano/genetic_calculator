 ...
 * @author Marano
 */
public abstract class TabelaModelo<T> extends ModeloAbstrato<T> implements TableModel {
    ...
    public TabelaModelo(JTable tabela) {
        this(tabela, null);
    }

    public TabelaModelo(JTable tabela, String[] campos) {
        this(tabela, campos, true);
    }

    public TabelaModelo(JTable tabela, String[] campos, boolean ordenada) {
        this(tabela, null, campos, ordenada);
    }

    public TabelaModelo(JTable tabela, List<T> objetos, String[] campos) {
        this(tabela, objetos, campos, true);
    }

    public TabelaModelo(JTable tabela, List<T> objetos, String[] campos, boolean ordenada) {
        this(tabela, objetos, campos, ordenada, false);
    }

    public TabelaModelo(JTable tabela, List<T> objetos, String[] campos, boolean ordenada, boolean esperarCarregar) {
    ...
    final public void setTabela(JTable tabela) {
        if (this.tabela != null) {
            ApresentacaoUtil.removerListener(controladorAcao, this.tabela);
            ApresentacaoUtil.removerListener(controladorSelecaoLista, this.tabela.getSelectionModel());
        }
        this.tabela = tabela;
        if (tabela != null) {
            setSelecaoMultipla(false);
            ApresentacaoUtil.adicionarListener(controladorAcao, tabela);
            ApresentacaoUtil.adicionarListener(controladorSelecaoLista, tabela.getSelectionModel());
...
//        }
    ...
    final public void notificar(TableModelEvent e) {
        Object[] listeners = TabelaModelo.this.listeners.getListenerList();
