...
public class ApresentacaoUtil {
    ...
    public static void setDesktop(JDesktopPane desktop) {
        ApresentacaoUtil.desktop = desktop;
    }
        ...
        public boolean postProcessKeyEvent(KeyEvent e) {
            if (e.getKeyCode() == e.VK_ESCAPE &&
                ...
                if (e.getSource() instanceof Component) {
                    Component pai = ApresentacaoUtil.getContainerPai((Component) e.getSource());
                    if (pai != null && !(telasSemFechamentoPorEsc.contains(pai.getClass()))) {
                        ApresentacaoUtil.fechar(pai);
                    }
                }
                return true;
            }
    ...
    public static <T> void set(T objeto, List<T> lista, ModeloAbstrato<T>... modelos) {
        ...
        for (ModeloAbstrato modelo : modelos) {
            modelo.set(objeto);
        }
    }

    public static <T> void set(T objeto, ModeloAbstrato<T>... modelos) {
        for (ModeloAbstrato modelo : modelos) {
            modelo.set(objeto);
        }
    }
