 ...
 * @author marano
 */
public abstract class ModeloAbstrato<T> implements ListaNotificavel {
    ...
    public ModeloAbstrato(List<T> lista) {
        this(lista, true);
    }

    public ModeloAbstrato(boolean ordenada) {
        this(null, ordenada);
    }

    public ModeloAbstrato(final List<T> lista, boolean ordenada) {
        this(lista, ordenada, false);
    }

    public ModeloAbstrato(final List<T> lista, boolean ordenada, boolean esperarCarregar) {
